  ...
  nav: {
    groups: {
      ...
      narrative: {
        ...
        items: {
          scrollHero: { label: "Story Hero", description: "Summit of Zhi Ge and Wusheng Mountain" },
          voidMap: { label: "Wusheng Lineage", description: "History, myth, and Zhi Ge positioning" },
          threeConcepts: { label: "Three Seals", description: "Blank · Covenant · Carving" },
          lineage: { label: "Three Martial Saints", description: "Jiang · Guan · Yue" },
          covenant: { label: "Zhi Ge Covenant", description: "The youth oath, full text" },
        },
      },
      timeline: {
        label: "Wuyin Vision",
        items: {
          roadAhead: { label: "Event Rhythm", description: "Warm-up · Entry · Finals · Sealing" },
          manifesto: { label: "Culture Week", description: "Forms, debate, forum, study tour" },
        },
      },
      nfts: {
        label: "Kung Fu Seal",
        items: {
          artifacts: { label: "Artifacts", description: "Digital collectibles entry" },
          minting: { label: "Minting", description: "Enter the forging workshop" },
        },
      },
      partnership: {
        label: "Wuyin Alliance",
        items: {
          entry: { label: "Partnership Home", description: "B2B landing" },
          modules: { label: "Modules", description: "Partnership types and strategy matrix" },
          imperative: { label: "Ecosystem Imperative", description: "Value proposition" },
          form: { label: "Apply", description: "Submit requirements for routing" },
        },
      },
    },
  },
